  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      ...
      <div className="grid gap-4 lg:grid-cols-[260px_1fr]">
        <div className="rounded-card border border-neutral-200 bg-white p-2">
          {KINDS.map((k) => {
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {VARIABLES.map((v) => (
                      <button
                        ...
                        className="rounded-md border border-neutral-200 bg-white px-2 py-1 font-mono text-xs text-neutral-700 hover:bg-neutral-50"
                      >
                        {v}
                      </button>
                    ))}
